        ...
        if ($pengguna == "" or $nik == "" or $katasandi == "" or $konfirmasisandi == "") {
            ...
            if ($katasandi != $konfirmasisandi) {
                ...
                if (mysqli_num_rows($sadmin) === 1) {
                    ...
                    mysqli_query($conn, "UPDATE sadmin SET Pengguna = '$pengguna', NIK = '$nik', Katasandi = '$katasandi' WHERE NIK = '$nik'");
                    $notif = "Data super admin berhasil diubah !";
                }else {
        ...
        <div class=" p-3 rounded" style="width: 300px; background:white;">
            <form action="" method="post">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="d-flex justify-content-center align-items-center">
                            <h4 class="mb-0">Ubah Super Admin</h4>
                        </div>
                    </div>
                </div>
                <!-- akhir label -->
